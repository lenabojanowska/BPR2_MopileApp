package com.example.mobileapp.activities.storeProduct.adapter;
...
public class StoreProductAdapter extends RecyclerView.Adapter<StoreProductAdapter.ViewHolder> {
    ...
    public StoreProductAdapter(List<ProductModel> productList, Context context, OnProductListener onProductListener) {
